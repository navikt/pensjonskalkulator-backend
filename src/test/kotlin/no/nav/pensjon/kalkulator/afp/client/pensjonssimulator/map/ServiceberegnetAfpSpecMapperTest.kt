...
class ServiceberegnetAfpSpecMapperTest : ShouldSpec({

    should("map all values and use simuleringstype 'AFP_FPP'") {
        ServiceberegnetAfpSpecMapper.toDto(
            ...
            personopplysninger = PersonopplysningerDto(
                ident = pid.value,
                fodselsdato = LocalDate.of(1970, 2, 15),
                valgtAfpOrdning = AfpOrdningType.FINANS,
                flyktning = true,
                antAarIUtlandet = 1,
                utenlandsopphold = listOf(
                    FppUtlandPeriodeDto(
                ...
                epsData = EpsDataDto(
                    valgtSivilstatus = SivilstatusTypeDto.SAMB,
                    registrertSivilstatus = FppSivilstandDto.UGIF,
                    epsMottarPensjon = true,
                    epsInntektOver2G = false,
                    tidligereGiftEllerBarnMedSamboer = true,
