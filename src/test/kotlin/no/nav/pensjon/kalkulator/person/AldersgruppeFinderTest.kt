...
class AldersgruppeFinderTest : ShouldSpec({
    ...
    should("return person's 10-year aldersgruppe") {
        ...
        with(finder) {
            aldersgruppe(person(foedselsaar = 1918)) shouldBe "100-109"
            aldersgruppe(person(foedselsaar = 1959)) shouldBe "60-69"
            aldersgruppe(person(foedselsaar = 1960)) shouldBe "60-69"
            aldersgruppe(person(foedselsaar = 1961)) shouldBe "50-59"
            aldersgruppe(person(foedselsaar = 2010)) shouldBe "10-19"
        }
    }
})
