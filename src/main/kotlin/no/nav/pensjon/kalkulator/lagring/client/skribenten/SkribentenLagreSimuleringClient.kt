...
@Component
class SkribentenLagreSimuleringClient(
    ...
    override fun lagreSimulering(lagreSimulering: LagreSimulering) {
        val uri = "/$LAGRE_SIMULERING_PATH"
        ...
        try {
            webClient
                ...
                .uri(uri)
                .headers(::setHeaders)
                .body(Mono.just(lagreSimulering), LagreSimulering::class.java)
                .retrieve()
                .toBodilessEntity()
    ...
    private companion object {
        private const val LAGRE_SIMULERING_PATH = "sak/{saksId}/brev"
