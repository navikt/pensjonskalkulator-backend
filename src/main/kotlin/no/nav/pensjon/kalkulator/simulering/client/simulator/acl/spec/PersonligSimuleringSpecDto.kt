 ...
 */
data class PersonligSimuleringSpecDto(
...
data class EpsSpecDto(
    val levende: LevendeEpsSpecDto? = null,
    val avdoed: AvdoedEpsSpecDto? = null
)

data class LevendeEpsSpecDto(
